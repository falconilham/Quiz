  ...
  render() 
  {
    {if(this.state.condition === 1){ 
      ...
      <View style={styles.container}>
        ...
        return (
      <View style={styles.container}>
      <Text style={{fontWeight: "bold", justifyContent:"flex-start",top: 0, position: "absolute",marginHorizontal: 10 , alignSelf:"flex-start", color: "white"}}>Silakan Mengerjakan {this.state.name}</Text>
